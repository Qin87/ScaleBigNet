...
# def load_genius_mat(n_classes=2, root="dataset/"):
#     dataset_url = {"genius": "https://github.com/CUAI/Non-Homophily-Large-Scale/blob/82f8f05c5c3ec16bd5b505cc7ad62ab5e09051e6/data/genius.mat"}
#     splits_url = {"genius": "https://github.com/CUAI/Non-Homophily-Large-Scale/blob/82f8f05c5c3ec16bd5b505cc7ad62ab5e09051e6/data/splits/genius-splits.npy"}

#     # Build dataset folder
#     if not os.path.exists(f"{root}genius"):
#         os.mkdir(f"{root}genius")

#     # Download the data
#     if not os.path.exists(f"{root}genius/genius.mat"):
#         p = dataset_url["genius"]
#         print(f"genius url: {p}")
#         gdown.download(
#             id=dataset_drive_url["pokec"],
#             output=f"{root}pokec/pokec.mat",
#             quiet=False,
